        ...
        if (
            ...
            try:
                ...
                while row_index < len(raw_df):
                    ...
                    file_ref = clean_text(safe_get_row_value(row_top, 2))
                    ...
                    vendors, purchasers = split_clients(
                    ...
                    # Old Excel format fallback:
                    # I column had solicitor values
                    if clean_text(solicitor_value_cell) == "":
                        solicitor_value_cell = safe_get_row_value(row_top, 8)
