...
if uploaded_file is not None:
    ...
    try:
        ...
        # STORE DATA
        st.session_state.records = existing_df.to_dict("records")

        st.success("✅ Existing records imported successfully!")
...
if st.session_state.records:
    ...
    if search_name:
        ...
        filtered_df = df[
            df["Vendors"].str.contains(search_name, case=False, na=False)
            |
            df["Purchasers"].str.contains(search_name, case=False, na=False)
        ]
